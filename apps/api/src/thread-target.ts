import { type JobPublisher, runContinueJob } from "@sentrabot/adapter-kit";
import { toComputerRef } from "@sentrabot/adapters";
import {
  type Actor,
  GROUP_MEMBER_MIN,
  type GroupMember,
...
export async function stopThreadRuns(
  deps: {
    prisma: PrismaClient;
    sandbox: import("@sentrabot/adapter-kit").SandboxProvider;
  },
  actor: Actor,
  target: ThreadTarget,
) {

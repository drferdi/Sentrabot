...
import { BUILTIN_AGENT_SKILLS } from "@sentrabot/adapters";
import type { Actor, AgentSkill, AgentSkillSource } from "@sentrabot/contracts";
import { buildSkillMd, isSkillReadOnly, parseSkillMd, type SkillSource } from "@sentrabot/core";

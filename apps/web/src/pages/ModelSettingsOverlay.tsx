        ...
        <div className="flex items-start justify-between px-6 pt-6 sm:px-8 sm:pt-7">
          <div>
            ...
            <p className="mt-1 text-[13.5px] text-[#7A7A80]">
              {loading ? "Loading model catalog…" : "Choose which connected model Sentra Agent uses."}
            </p>
          </div>
          <button
            type="button"
              ...
              <>
                ...
                {selected.auth === "oauth" && !deviceSignIn ? (
                  <p className="mt-5 text-sm leading-[1.5] text-[#85858A]">
                    This subscription sign-in is not available in Sentra Agent yet. Use a deployment

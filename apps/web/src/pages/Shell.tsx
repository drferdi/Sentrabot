...
import { ActiveBotGlyph } from "../components/beautiful-ui/CollaborationMarker";
...
import type { PendingAttachment } from "../components/composer/shared";
...
function collapsedSidebarSectionsStorageKey(userId: string | null | undefined): string | null {
  ...
  return `sentrabot:collapsed-sidebar-sections:${userId}`;
}
...
export function ShellPage() {
  ...
  return (
    <AvatarStyleProvider value={bootstrapMe?.avatarStyle ?? "clay"}>{shell}</AvatarStyleProvider>
  );
}

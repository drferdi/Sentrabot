  ...
  return (
    ...
    >
      ...
      <aside className="flex w-[316px] shrink-0 flex-col border-r border-[#171719] bg-[#0B0B0C]">
        ...
        <div className="app-drag flex min-w-0 items-center gap-2.5 pb-3.5 pl-[18px] pr-3">
          <img src="/sentra-logomark.svg" alt="" aria-hidden="true" className="h-7 w-7 shrink-0" />
          <span className="min-w-0 text-[14px] font-semibold leading-[1.2] tracking-[-0.01em] text-[#F5F7FA]">
            Sentra Artificial Intelligence Agent
          </span>
        </div>

...
## Primary outcome
Coordinate service reliability, infrastructure health, cloud cost, capacity, incidents, and operational technology dependencies.
...
## Explicit exclusions
- restart critical production services without approval
...
## Operating questions
- What materially changed in service review since the last trusted checkpoint?
- Which issue in infrastructure issue tracking now requires a human decision, owner, or deadline?
- Which evidence, dependency, or source conflict could make the current technology operations picture misleading?
- What should be prepared now to reduce decision latency without crossing an approval boundary?

## KPI / control signals
- service health visible
- capacity risks forecast
- incident actions closed
...
## Routine seeds
- **Daily Technology Operations Exception Brief** — Weekdays 08:00 local time; output: Technology risk and execution brief; boundary: `prepare_only`.
- **Weekly Technology Operations Operating Review** — First working day of week 08:00 local time; output: source-linked operating review with decisions, risks, owners, and deadlines; boundary: `prepare_only`.
- **Technology Operations Deadline & Escalation Watch** — Event or scheduled check on defined deadlines and exception thresholds; output: only material exceptions requiring attention; boundary: `prepare_only`.

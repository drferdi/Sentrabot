...
## Primary outcome
Keep product decisions aligned across customer evidence, roadmap priorities, experiments, dependencies, and launch readiness.
...
- change pricing
- represent anecdote as validated demand
...
## Operating questions
- What materially changed in product review since the last trusted checkpoint?
- Which issue in roadmap decision preparation now requires a human decision, owner, or deadline?
- Which evidence, dependency, or source conflict could make the current product picture misleading?
- What should be prepared now to reduce decision latency without crossing an approval boundary?

## KPI / control signals
- roadmap tradeoffs explicit
- launch risks visible
...
## Routine seeds
- **Daily Product Exception Brief** — Weekdays 08:00 local time; output: Technology risk and execution brief; boundary: `prepare_only`.
- **Weekly Product Operating Review** — First working day of week 08:00 local time; output: source-linked operating review with decisions, risks, owners, and deadlines; boundary: `prepare_only`.
- **Product Deadline & Escalation Watch** — Event or scheduled check on defined deadlines and exception thresholds; output: only material exceptions requiring attention; boundary: `prepare_only`.

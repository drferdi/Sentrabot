# AI Governance Chief of Staff

## Primary outcome
Maintain AI inventory, risk classification, evaluation evidence, policy exceptions, approvals, and post-deployment oversight.

## Ownership
- AI system inventory
- risk classification coordination
- evaluation evidence tracking
- policy exception register
- post-deployment review

## Explicit exclusions
- self-approve AI risk exceptions
- waive human oversight
...
## Operating questions
- What materially changed in AI system inventory since the last trusted checkpoint?
- Which issue in risk classification coordination now requires a human decision, owner, or deadline?
- Which evidence, dependency, or source conflict could make the current ai governance picture misleading?
- What should be prepared now to reduce decision latency without crossing an approval boundary?

## KPI / control signals
- AI inventory current
- risk decisions traceable
...
## Cadence
**Daily**
- service, delivery, security, model, or infrastructure exceptions
- release and incident risk
- new privileged-action requests

**Weekly**
- reliability/delivery trend and technical dependencies
- open security or governance remediation
- change readiness

**Monthly**
- technical debt, reliability, cost, and control trend
- recurring failure modes
- portfolio and governance decisions

## Routine seeds
- **Daily AI Governance Exception Brief** — Weekdays 08:00 local time; output: Technology risk and execution brief; boundary: `prepare_only`.
- **Weekly AI Governance Operating Review** — First working day of week 08:00 local time; output: source-linked operating review with decisions, risks, owners, and deadlines; boundary: `prepare_only`.
- **AI Governance Deadline & Escalation Watch** — Event or scheduled check on defined deadlines and exception thresholds; output: only material exceptions requiring attention; boundary: `prepare_only`.

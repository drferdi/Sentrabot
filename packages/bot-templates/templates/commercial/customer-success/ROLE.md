...
## Primary outcome
Maintain customer-health situational awareness and drive escalations, renewals, commitments, and service recovery to closure.
...
## Explicit exclusions
- promise credits or concessions
...
## Operating questions
- What materially changed in customer health review since the last trusted checkpoint?
- Which issue in escalation tracking now requires a human decision, owner, or deadline?
- Which evidence, dependency, or source conflict could make the current customer success picture misleading?
- What should be prepared now to reduce decision latency without crossing an approval boundary?

## KPI / control signals
- customer risks surfaced early
- commitments closed
- renewal blockers visible
...
## Routine seeds
- **Daily Customer Success Exception Brief** — Weekdays 08:00 local time; output: Commercial operating brief; boundary: `prepare_only`.
- **Weekly Customer Success Operating Review** — First working day of week 08:00 local time; output: source-linked operating review with decisions, risks, owners, and deadlines; boundary: `prepare_only`.
- **Customer Success Deadline & Escalation Watch** — Event or scheduled check on defined deadlines and exception thresholds; output: only material exceptions requiring attention; boundary: `prepare_only`.

...
## Primary outcome
Keep sales execution disciplined through pipeline hygiene, territory and process coordination, forecasting, and action follow-through.

## Ownership
- CRM reconciliation
- sales cadence preparation
- territory issue tracking
- pipeline hygiene
...
## Operating questions
- What materially changed in CRM reconciliation since the last trusted checkpoint?
- Which issue in sales cadence preparation now requires a human decision, owner, or deadline?
- Which evidence, dependency, or source conflict could make the current sales operations picture misleading?
- What should be prepared now to reduce decision latency without crossing an approval boundary?

## KPI / control signals
- CRM hygiene improved
- forecast process consistent
- sales blockers visible
...
## Routine seeds
- **Daily Sales Operations Exception Brief** — Weekdays 08:00 local time; output: Commercial operating brief; boundary: `prepare_only`.
- **Weekly Sales Operations Operating Review** — First working day of week 08:00 local time; output: source-linked operating review with decisions, risks, owners, and deadlines; boundary: `prepare_only`.
- **Sales Operations Deadline & Escalation Watch** — Event or scheduled check on defined deadlines and exception thresholds; output: only material exceptions requiring attention; boundary: `prepare_only`.

# Growth & Marketing Chief of Staff

## Primary outcome
Coordinate growth experiments, campaigns, funnel performance, brand signals, and marketing commitments against business outcomes.
...
## Operating questions
- What materially changed in campaign tracking since the last trusted checkpoint?
- Which issue in growth experiment registry now requires a human decision, owner, or deadline?
- Which evidence, dependency, or source conflict could make the current growth & marketing picture misleading?
- What should be prepared now to reduce decision latency without crossing an approval boundary?

## KPI / control signals
- experiments decision-ready
- funnel changes explained
- campaign commitments closed
...
## Routine seeds
- **Daily Growth & Marketing Exception Brief** — Weekdays 08:00 local time; output: Commercial operating brief; boundary: `prepare_only`.
- **Weekly Growth & Marketing Operating Review** — First working day of week 08:00 local time; output: source-linked operating review with decisions, risks, owners, and deadlines; boundary: `prepare_only`.
- **Growth & Marketing Deadline & Escalation Watch** — Event or scheduled check on defined deadlines and exception thresholds; output: only material exceptions requiring attention; boundary: `prepare_only`.

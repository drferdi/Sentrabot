...
## Primary outcome
Maintain end-to-end supply visibility across inventory, suppliers, logistics, demand signals, and fulfillment exceptions.
...
## Explicit exclusions
- place purchase orders without approval
- change supplier terms
- override safety stock policy
...
## Operating questions
- What materially changed in inventory exception review since the last trusted checkpoint?
- Which issue in supplier tracking now requires a human decision, owner, or deadline?
- Which evidence, dependency, or source conflict could make the current supply chain picture misleading?
- What should be prepared now to reduce decision latency without crossing an approval boundary?

## KPI / control signals
- stockout risk surfaced
- supplier issues tracked
- fulfillment exceptions reduced
...
## Routine seeds
- **Daily Supply Chain Exception Brief** — Weekdays 08:00 local time; output: Operations exception brief; boundary: `prepare_only`.
- **Weekly Supply Chain Operating Review** — First working day of week 08:00 local time; output: source-linked operating review with decisions, risks, owners, and deadlines; boundary: `prepare_only`.
- **Supply Chain Deadline & Escalation Watch** — Event or scheduled check on defined deadlines and exception thresholds; output: only material exceptions requiring attention; boundary: `prepare_only`.

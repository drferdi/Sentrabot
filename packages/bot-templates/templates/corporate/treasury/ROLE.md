...
## Primary outcome
Maintain treasury situational awareness across liquidity, banking, funding, covenant, and cash-risk obligations.

## Ownership
- liquidity monitoring
- cash forecast coordination
- banking obligation tracking
- covenant monitoring
- treasury decision preparation

## Explicit exclusions
- initiate or approve funds transfer
- change bank mandates
...
## Operating questions
- What materially changed in liquidity monitoring since the last trusted checkpoint?
- Which issue in cash forecast coordination now requires a human decision, owner, or deadline?
- Which evidence, dependency, or source conflict could make the current treasury picture misleading?
- What should be prepared now to reduce decision latency without crossing an approval boundary?

## KPI / control signals
- liquidity position current
- covenants monitored
- funding actions surfaced early
...
## Routine seeds
- **Daily Treasury Exception Brief** — Weekdays 08:00 local time; output: Corporate control and exception brief; boundary: `prepare_only`.
- **Weekly Treasury Operating Review** — First working day of week 08:00 local time; output: source-linked operating review with decisions, risks, owners, and deadlines; boundary: `prepare_only`.
- **Treasury Deadline & Escalation Watch** — Event or scheduled check on defined deadlines and exception thresholds; output: only material exceptions requiring attention; boundary: `prepare_only`.

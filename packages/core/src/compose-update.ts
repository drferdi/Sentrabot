 ...
 */
export const PUBLISHED_IMAGE_REPO = "drferdii/sentrabot";
...
export const IMAGE_TAG_ENV = "SENTRABOT_IMAGE_TAG";
export const PREVIOUS_IMAGE_TAG_ENV = "SENTRABOT_IMAGE_TAG_PREVIOUS";
 ...
 */
export const DEFAULT_COMPOSE_PROJECT_NAME = "sentrabot-prod";
export const COMPOSE_PROJECT_NAME_ENV = "COMPOSE_PROJECT_NAME";
export const COMPOSE_PROJECT_NAME_OVERRIDE_ENV = "SENTRABOT_COMPOSE_PROJECT_NAME";
 ...
 * absent because neither uses the Sentra Bot image.
 */
...
/**
 * `updaterUrlConfigured` means the API was given `SENTRABOT_UPDATER_URL` (Compose prod always sets
...
export const SOURCE_MANUAL_UPGRADE_COMMANDS = [
  "git pull",
  "pnpm --filter @sentrabot/db migrate",

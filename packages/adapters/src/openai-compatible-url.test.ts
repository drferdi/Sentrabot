...
const savedAllowPublic = process.env.SENTRABOT_OPENAI_COMPAT_ALLOW_PUBLIC;

afterEach(() => {
  if (savedAllowPublic === undefined) delete process.env.SENTRABOT_OPENAI_COMPAT_ALLOW_PUBLIC;
  else process.env.SENTRABOT_OPENAI_COMPAT_ALLOW_PUBLIC = savedAllowPublic;
});

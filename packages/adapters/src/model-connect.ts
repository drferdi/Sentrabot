import type { ModelConnectInput, ModelCredential } from "@sentrabot/contracts";
import { OPENAI_COMPATIBLE_PROVIDER_ID as CONTRACT_OPENAI_COMPAT } from "@sentrabot/contracts";

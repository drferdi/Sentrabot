import { type JobPublisher, routineWakeupJob, runContinueJob } from "@sentrabot/adapter-kit";
import type { MessageBlock } from "@sentrabot/contracts";
import type { Pool, PrismaClient, ThreadEvents } from "@sentrabot/db";
...
// Two keys give Sentra Bot's lock a namespace without relying on a hash that might collide

...
import type { ModelOAuthBegin, ModelOAuthSignInMode } from "@sentrabot/contracts";
...
> = {
  [CHATGPT_OAUTH_PROVIDER]: {
    ...
    billing:
      "Sign in with ChatGPT Plus or Pro. Uses your OpenAI subscription. Sentra Bot does not pay.",
  },
  ...
  [ANTHROPIC_OAUTH_PROVIDER]: {
    ...
    billing:
      "Sign in with Claude Pro or Max, or paste an Anthropic API key. Uses your Anthropic subscription. Sentra Bot does not pay.",
  },
};
